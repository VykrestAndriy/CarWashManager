...
public class WashServiceDecorator : IWashService
{
    ...
    public Task CreateWashAsync(WashDto washDto)
    {
        return _inner.CreateWashAsync(washDto);
    }

    public Task<WashDto> GetWashByIdAsync(Guid washId)
    {
        throw new NotImplementedException();
    }

    public Task<IEnumerable<WashDto>> GetAllWashesAsync()
    {
        throw new NotImplementedException();
    }
